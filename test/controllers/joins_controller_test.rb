...
class JoinsControllerTest < ActionController::TestCase
  ...
  test "should create join" do
    assert_difference('Join.count') do
      post :create, join: { event_id: @join.event_id, society_id: @join.society_id, user_id: @join.user_id }
    end
  ...
  test "should update join" do
    patch :update, id: @join, join: { event_id: @join.event_id, society_id: @join.society_id, user_id: @join.user_id }
    assert_redirected_to join_path(assigns(:join))
  end
