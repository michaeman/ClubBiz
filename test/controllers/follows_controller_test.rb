...
class FollowsControllerTest < ActionController::TestCase
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post :create, follow: { society_id: @follow.society_id, user_id: @follow.user_id }
    end
  ...
  test "should update follow" do
    patch :update, id: @follow, follow: { society_id: @follow.society_id, user_id: @follow.user_id }
    assert_redirected_to follow_path(assigns(:follow))
  end
